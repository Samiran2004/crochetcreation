        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 flex items-center justify-between">
          ...
          >
            ...
            <span className="hidden sm:block">
              <span className="text-2xl md:text-4xl font-avenue text-[#FEF9F6] block leading-none pt-1">
                Crochet Creation
              </span>
            ...
            <span className="sm:hidden text-2xl md:text-3xl font-avenue text-[#FEF9F6] pt-1">Crochet Creation</span>
          </Link>
